...
TEST(BlockTest1, CheckingSimpleDiff) {
  ...
  vector<string> expectedOutput =
      loadExpectedResults("/home/runner/work/DiffCpp/DiffCpp/test/BlockTests/"
                          "TestCase1/ExpectedResults.txt");
...
TEST(UnitTest1, CheckingLoadingLines) {
  char *argvArray[3];
  char **argv = argvArray;
  argvArray[1] = (char *)"/home/runner/work/DiffCpp/DiffCpp/test/UnitTests/"
                         "TestCase1/Input.txt";
  argvArray[2] = (char *)"/home/runner/work/DiffCpp/DiffCpp/test/UnitTests/"
                         "TestCase1/Input.txt";
  ...
  vector<string> expectedOutput =
      loadExpectedResults("/home/runner/work/DiffCpp/DiffCpp/test/UnitTests/"
                          "TestCase1/ExpectedResults.txt");
